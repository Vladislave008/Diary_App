...
# 1) сделать отдельную страницу для случая, если акк не подтвержден (сейчас он просто удаляется), лучше создать кнопку для повторной отправки письма
# 2) обработать случаи попыток входа в аккаунт во время обратного отсчета подтверждения